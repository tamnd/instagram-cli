...
description: "What changed in each ig release, newest first."
weight: 40
---
...
- [v0.1.0](/release-notes/v0-1-0/) — the first public release: profiles, posts,
  and reels across both reading planes, with the walled exit and the shortcode
  codec.
